...
class MultiHeadAttention(nn.Module):
    ...
    def __init__(self, num_heads, head_size) -> None:
        ...
        self.proj = nn.Linear(n_embd, n_embd) # TODO: check residual connection idea
        self.dropout = nn.Dropout(dropout)
...
class TransformerLanguageModel(nn.Module):
    ...
    def __init__(self):
        ...
        self.blocks = nn.Sequential(*[Block(n_embd, n_heads=n_heads) for _ in range(n_layer)]) # In Python, * is used to unpack the list
